...
# (project=scitex-os, owner=ywatanabe1989, repo=scitex-os,
...
TMPDIR="/tmp/publish-scitex_os-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-os dist/* uploaded to PyPI via manual OIDC trusted publishing"
